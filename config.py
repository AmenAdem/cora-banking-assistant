...
def parse_list_from_env(env_key, default=None):
    """Pars ea comma-separated list from an environment variable."""
...
class Settings:
    ...
    def __init__(self):
        ...
        self.DESCRIPTION = os.getenv(
            "DESCRIPTION", "CORA #Customer Operations & Reasoning Agent# is an AI-powered customer support agent designed for intelligent, contextual resolution of customer requests in banking and financial services. "
        )
        ...
        print(self.RATE_LIMIT_ENDPOINTS)
